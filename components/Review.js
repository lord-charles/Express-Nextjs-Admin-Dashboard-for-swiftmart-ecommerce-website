...
export default function Review() {
  ...
  return (
    <div>
      ...
      <Grid container className='flex justify-between' gutterBottom sx={{ mt: 2 }}>
      ...
      <Typography variant='body2' gutterBottom sx={{ mt: 2, fontWeight: 700 }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={12}>
          ...
          <Typography gutterBottom>Category quantity:{product.category?.map(product => product.quantity)}</Typography>
        </Grid>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <Typography gutterBottom>Brand quantity:{product.brand?.map(product => product.quantity)}</Typography>
        </Grid>
        ...
        <Grid item container direction='column' xs={12} sm={6}>
          ...
          <Grid>
            ...
            <Typography gutterBottom>Color quantity:{product.colors?.map(product => product.availability)}</Typography>
          </Grid>
        </Grid>
      </Grid>
            ...
            {product.images?.map((product, index) => {
              return (
                <Grid container spacing={2} key={index}>
                  <Image src={product.url} width={500} height={300} alt='image' key={index} />
                </Grid>
              )
            })}
          </Grid>
